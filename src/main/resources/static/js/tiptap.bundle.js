...
var index_default2 = Placeholder;

// node_modules/@tiptap/extension-character-count/dist/index.js
var index_default3 = CharacterCount;

// frontend/tiptap/main.js
var CHAR_LIMIT = 1e4;
var MAX_MEDIA_ITEMS = 10;
var bindToolbarActions = (editor) => {
...
var bindMediaManager = () => {
  ...
  const renderList = () => {
    ...
    if (!mediaItems.length) {
      ...
      empty2.className = "mediaEmpty";
      empty2.textContent = "\uCCA8\uBD80\uB41C \uD30C\uC77C\uC774 \uC5C6\uC2B5\uB2C8\uB2E4.";
      previewList.appendChild(empty2);
      return;
    }
    mediaItems.forEach((item, index) => {
      ...
      thumb.textContent = item.type.startsWith("video") ? "\u{1F3AC}" : "\u{1F5BC}";
      ...
      size.textContent = `${formatBytes(item.size)} \xB7 ${item.type}`;
